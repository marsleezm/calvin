...
DeterministicScheduler::DeterministicScheduler(Configuration* conf,
	...
	pending_txns_ = new priority_queue<MyFour<int64_t, int64_t, int, bool>,  vector<MyFour<int64_t, int64_t, int, bool>>, CompareFour>*[num_threads];
